          ...
          <div className="home-header-container">
            <div className="home-header">
              <h1 className="home-heading">
                ...
                <span className="home-text09">imagination</span>
                <br></br>
              </h1>
            </div>
      ...
      <section className="home-slider">
        <div className="home-header04">
          <h2 className="home-heading01">
            ...
            <span className="home-text15">o</span>
    ...
    enableAutoplay: true,
      ...
      <section className="home-objectives">
        <div className="home-content05">
          <span className="home-text22">Objectives</span>
          ...
          <div className="home-header10">
            <div className="home-header11">
              <h2 className="home-heading07">
                ...
                <span className="home-text30">growth.</span>
                <br></br>
              </h2>
            </div>
        ...
        <div className="home-content08">
          <div className="home-header12">
            <div className="home-header-container2">
              <div className="home-header13">
                <h2 className="home-heading08">
                  ...
                  <span className="home-text35">experience</span>
                </h2>
              </div>
            ...
            <div className="home-checkmarks">
              ...
              <div className="home-check1">
                ...
                <span className="home-text37">Lorem ipsum dolor sit amet</span>
              </div>
          ...
          <div className="home-testimonial1">
            <div className="home-content09">
              <span className="home-text40">Testimonial</span>
        ...
        <div className="home-content10">
          <div className="home-header14">
            <h2 className="home-heading09">
              ...
              <span className="home-text43">environment</span>
              <span> now!</span>
              <br></br>
            </h2>
          </div>
        ...
        <div className="home-header-container3">
          <div className="home-header15">
            <h2 className="home-heading10">
              ...
              <span className="home-text50">omparision</span>
              <br></br>
            </h2>
          </div>
        ...
        <div className="home-table">
          <div className="home-row">
            <div className="home-headers">
              <span className="home-text52">Placeholder</span>
            </div>
            <div className="home-plans">
              <div className="home-row01">
                <span className="home-text53">TOGHTR</span>
                <span className="home-text54">AGENCY</span>
                <span className="home-text55">FRELLANCE</span>
              </div>
            </div>
          </div>
          ...
          <div className="home-row06">
            ...
            <div className="home-plans3">
              <div className="home-row07">
                <div className="value">
                  <span className="home-text59">Custom</span>
                </div>
                <div className="value">
                  <Line></Line>
                </div>
          ...
          <div className="home-row08">
            ...
            <div className="home-plans4">
              <div className="home-row09">
                <div className="value">
                  <span className="home-text61">Unlimited</span>
                </div>
                <div className="value">
                  <span className="home-text62">Limited</span>
                </div>
                <div className="value">
                  <Line></Line>
                </div>
          ...
          <div className="home-header16">
            <div className="home-row16">
              <h2 className="home-heading11">
                ...
                <span className="home-text69">platform</span>
                <br></br>
              </h2>
            </div>
          </div>
      ...
      <section className="home-customer">
        <div className="home-header21">
          <h2 className="home-heading12">
            ...
            <span className="home-text72">product development process</span>
            <br></br>
          </h2>
        </div>
      ...
      <section className="home-f-a-q">
        <div className="home-header22">
          <h2 className="home-heading13">
            ...
            <span className="home-text78">questions</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
              ...
              <div className="home-column2">
                ...
                <div className="home-list">
                  ...
                  <Link to="/" className="home-navlink03">
                    <span className="home-text81">Why</span>
                    <br></br>
                  </Link>
                </div>
              </div>
